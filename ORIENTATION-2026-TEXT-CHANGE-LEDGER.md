...
| Slide counter | `1 / 26`, scrubber maximum `26` | `1 / 38`, scrubber maximum `38` |
...
**After:** “38 slides following the updated 2026 orientation outline,” an explicit note that the deck adds the Data Quilt, Commons profiles/CVs, courses, groups, and sites, and a screenshot-only Tagging the Tower slide; the Manifold sequence now uses the required source images and relationships inside the orientation deck's larger shared typography and content/image layouts.
