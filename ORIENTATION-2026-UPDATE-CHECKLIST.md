...
37. [x] After explicit user approval, push the August 25 Certificates/TOC follow-up as `1376b35`; wait for GitHub Pages run `32852977192` to finish successfully; and independently live-verify the exact copy, responsive TOC geometry, counters, containment, matching versioned assets, byte-identical served HTML/CSS/JavaScript, and empty browser console.
...
- [x] Publish and independently live-verify the August 25 Certificates/TOC follow-up from `1376b35` after explicit approval and terminal GitHub Pages success in run `32852977192`.
